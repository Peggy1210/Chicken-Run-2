...
ChicksTower::ChicksTower(int dir){
    this->direction = dir;
    this->circle = new Circle(400, 450, 200);
    TowerImage = al_load_bitmap("./tower/TowerLV3.png");
    BulletImage = al_load_bitmap("./tower/BulletLV3.png");
    chickslife = 10000*2;
    Level = 2;
    font = al_load_font("./fonts/pirulen.ttf", 24, 0);
    cooltimeimg_lower = al_load_bitmap("./tower/cooltimeLV3.png");
    cooltimeimg_upper = al_load_bitmap("./tower/cooltimebutton.png");
}

ChicksTower::ChicksTower(int level, int dir, int HP){
    this->direction = dir;
    this->circle = new Circle(400, 450, 200);
    char buffer[50];
    ...
    chickslife = 10000*level+HP*5000;
    Level = level;
    font = al_load_font("./fonts/pirulen.ttf", 24, 0);
