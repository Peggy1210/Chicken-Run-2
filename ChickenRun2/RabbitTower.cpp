...
RabbitTower::RabbitTower(int dir){
    this->direction = dir;
    this->circle = new Circle(window_width-400, 450, 200);
    char buffer[50];
    TowerImage = al_load_bitmap("./tower/rightTower.png");
    BulletImage = al_load_bitmap("./tower/rightBullet.png");
    chickslife = 10000*2;
    Level = 2;
    font = al_load_font("./fonts/pirulen.ttf", 24, 0);
    cooltimeimg_lower = al_load_bitmap("./tower/rightCooltime.png");
